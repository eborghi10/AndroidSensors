...
/**
 * Allows the user to configue a master {@link java.net.URI} then it returns that
 * {@link java.net.URI} to the calling {@link android.app.Activity}.
 * <p>
 * When this {@link android.app.Activity} is started, the last used (or the default)
 * {@link java.net.URI} is displayed to the user.
 * 
